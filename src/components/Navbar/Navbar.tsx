...
const Navbar: React.FC = () => {
  ...
  return (
    <div className="fixed -right-1.5 z-20">
      <button
      ...
      {active && (
        <nav className=" float-right border-l-2 border-white px-4 md:px-8 pt-24 w-1/3 h-screen bg-black md:w-1/6">
          <div>
          ...
          <div className="flex flex-wrap">
            ...
            <button className="bg-white w-6 h-6 md:w-8 md:h-8 ml-2 mr-6 mt-2 py-2 rounded">
              <img src={med} />
            </button>
            <button className="w-6 h-6 md:w-8 md:h-8 ml-2 mr-6 mb-4 py-2">
              <img src={fb} />
